...
<%
    ...
    try {
        ...
        int i = st.executeUpdate("update files set data='"+endata+"',file_key='"+skey+"'where filename='"+fname+"' AND keyword1='"+keyword1+"' AND keyword2='"+keyword2+"' AND keyword3='"+keyword3+"' AND owner='"+uname+"'");
        if (i != 0) {
