                ...
                <div class="fupload" style="border: 1px solid red;border-top-left-radius: 20px;border-bottom-right-radius: 20px;background: white;width: 500px;height: 300px;margin-left: 400px;margin-top: 60px">
                    ...
                    <center> 
                        <form name="f2" action="Upload" method="post" enctype="multipart/form-data"style="margin-right:  50px">
                            ...
                            <label style="font-size: 23px">File Keyword1 </label><input class="textbox" type="text" placeholder="Enter your Keyword1" name="fkey1" style="margin-left: 45px;width: 250px" required=""/><br /><br />
                            <label style="font-size: 23px">File Keyword2 </label><input class="textbox" type="text" placeholder="Enter your Keyword2" name="fkey2" style="margin-left: 45px;width: 250px"/><br /><br />
                            <label style="font-size: 23px">File Keyword3 </label><input class="textbox" type="text" placeholder="Enter your Keyword3" name="fkey3" style="margin-left: 45px;width: 250px"/><br /><br />
                    ...
                    <center>
                        <table border="1" style="text-align: center">
                            ...
                            <tr>
                                ...
                                <td><%=rs.getString("keyword1")%></td>
                                <td><%=rs.getString("keyword2")%></td>
                                <td><%=rs.getString("keyword3")%></td>
                                ...
                                <td><a href="delete.jsp?<%=rs.getString("filename")%>,<%=rs.getString("keyword1")%>,<%=rs.getString("keyword2")%>,<%=rs.getString("keyword3")%>,<%=uname%>">Delete</a></td>
                            </tr>
                            <%}
                                } catch (Exception ex) {
                                    ex.printStackTrace();
