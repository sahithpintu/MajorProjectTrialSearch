 ...
 */
package src.java.com.secure.kk.action;
            ...
            try {
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        } else if (fileItem.getFieldName().equals("fkey1")) {
                            keyword1 = fileItem.getString();
                            System.out.println("File Keyword1" + keyword1);
                        }
                        else if (fileItem.getFieldName().equals("fkey2")) {
                             keyword2 = fileItem.getString();
                            System.out.println("File Keyword2" + keyword2);
                        }
                        else if (fileItem.getFieldName().equals("fkey3")) {
                             keyword3 = fileItem.getString();
                            System.out.println("File Keyword3" + keyword3);
                        } else {
                        ...
                        if (isFormField) {
                            ...
                            try {
                                ...
                                pstm = con.prepareStatement("insert into files (file, keyword1, keyword2, keyword3, filetype, filename, CDate, owner, size, data, frank, file_key)values(?,?,?,?,?,?,?,?,?,?,?,?)");
                                ...
                                pstm.setString(2, keyword1);
                                pstm.setString(3, keyword2);
                                pstm.setString(4, keyword3);
                                pstm.setString(5, b);
                                pstm.setString(6, fname);
                                pstm.setDate(7, getCurrentDate());
                                pstm.setString(8, a);
                                pstm.setLong(9, fileItem.getSize());
                                pstm.setString(10, cipher);
                                pstm.setString(11, "0");
                                pstm.setString(12, skey);
                                /*Cloud Start*/
